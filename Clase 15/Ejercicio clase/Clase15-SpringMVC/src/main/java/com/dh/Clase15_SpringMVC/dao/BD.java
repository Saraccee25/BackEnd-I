...
public class BD {
    ...
    private static final String SQL_INSERT_PACIENTE = "INSERT INTO PACIENTES (ID, NOMBRE, APELLIDO, DOMICILIO, DNI, FECHA_ALTA) " +
            "VALUES (1, 'Juan', 'Pérez', 'Calle Falsa 123', '12345678A', '2024-08-15')";
